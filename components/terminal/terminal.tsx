...
export function Terminal() {
  ...
  return (
    <div
      className={cn(
        'fixed bottom-0 left-1/2 -translate-x-1/2 w-[380px] bg-gray-900/95 rounded-t-lg border border-gray-800 shadow-xl backdrop-blur-sm transition-all duration-300 ease-in-out z-50',
    ...
    >
      <div className="flex items-center justify-between p-2 border-b border-gray-800">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-200">Steve Terminal</span>
        </div>
      ...
      {!isMinimized && (
        <>
          ...
          >
            {messages.length === 0 && (
              <div className="text-sm text-gray-500 text-center mt-4">
                Type a message to start the conversation with Steve
              </div>
            )}
          ...
          <form
            ...
            className="absolute bottom-0 left-0 right-0 p-2 bg-gray-900/50 border-t border-gray-800"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className={cn(
                    "w-full bg-gray-800 text-gray-100 rounded px-3 py-2 text-sm",
              ...
              <button
                ...
                className={cn(
                  "px-3 py-2 bg-violet-600 text-white rounded",
